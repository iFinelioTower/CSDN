/*
 * Copyright 2019. iFinelio Tower <308662170@qq.com>
 *
...
/**
 * Default style <bezier + arrows>
 */
public class DefaultSliderView implements ISliderView {
    private Path bezierPath;
    private Paint paint, arrowPaint;
	private static final String TAG = "DefaultSliderView";
    ...
    public DefaultSliderView(@NonNull Context context) {
        width = WindowUtils.d2p(context, 50);
        height = WindowUtils.d2p(context, 200);
        arrowWidth = WindowUtils.d2p(context, 4);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        paint.setStrokeWidth(WindowUtils.d2p(context, 1.5f));

        arrowPaint = new Paint();
        arrowPaint.setAntiAlias(true);
        arrowPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        arrowPaint.setColor(arrowColor);
        arrowPaint.setStrokeWidth(WindowUtils.d2p(context, 1.5f));
